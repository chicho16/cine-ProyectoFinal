...
if(isset($_GET['id'])){
	$mov = $conn->query("SELECT * FROM pelicula where id_pelicula =".$_GET['id']);
	...
	<div class="col-lg-12">
		<form id="manage-movie">
			...
			<div class="form-group row">
				<label for="" class="control-label col-md-12">Duración</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Fecha de Apertura</label>
			...
			<!--Link del trailer-->
			<div class="form-group">
				<label for="" class="control-label">Link del Tráiler</label>
				<input name="trailer_yt_link" id="" type="text" class="form-control" value="<?php echo isset($meta['trailer_yt_link']) ? $meta['trailer_yt_link'] : '' ?>" required>
			</div>
			...
			<div class="form-group input-group">
				<label for="" class="control-label">Cartel</label>
				<br>
				<div class="input-group-prepend">
				  ...
				  <div class="custom-file">
				    ...
				    <label class="custom-file-label" for="cover-img">Elegir Archivo</label>
				  </div>
			</div>
