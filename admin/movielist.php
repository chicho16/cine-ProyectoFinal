...
<div class="container-fluid">
	<div class="row">
		<div class="col-md-12">
			<button class="btn btn-block btn-sm btn-primary col-sm-2" type="button" id="new_movie"><i class="fa fa-plus"></i> Nueva Pelicula</button>
		</div>
	</div>
	<div class="row">
			...
			<div class="card-body">
				<table class="table table-bordered">
					...
					<tbody>
						<?php
						$i = 1;
						$movie = $conn->query("SELECT * FROM pelicula ");
						 	...
						 	<td>
								...
								<div class="btn-group">
								  ...
								  <div class="dropdown-menu">
								    <a class="dropdown-item edit_movie" href="javascript:void(0)" data-id = '<?php echo $row['id_pelicula'] ?>'>Editar</a>
								    <div class="dropdown-divider"></div>
								    <a class="dropdown-item delete_movie" href="javascript:void(0)" data-id = '<?php echo $row['id_pelicula'] ?>'>Eliminar</a>
								  </div>
								</div>
								</center>
						 	</td>
