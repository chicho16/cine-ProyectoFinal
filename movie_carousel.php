<?php 
  ...
  $movies = $conn->query("SELECT * FROM pelicula where '".date('Y-m-d')."' BETWEEN date(date_showing) and date(end_date) order by rand() limit 10");
?>

     
                  <center><h3 class="text-primary">“Las ideas son fáciles, implementarlas es lo difícil”- Guy Kawasaki</h3></center>
